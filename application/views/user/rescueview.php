          ...
          <section class="wrapper">
              <div class="row mt">
                  <div class="col-md-12">
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="name">Recipient's Name:</label>
                        <label class="col-md-4 control-label" for="name"><?= $rescues->rname ?></label>  
                    </div>

                    <!-- Textarea -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="description">Recipient's Address:</label>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="description">Time of Rescue:</label>
                        <label class="col-md-4 control-label" for="description"><?= $rescues->times ?></label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <a class="btn btn-info" href="<?= base_url() . 'user/Volunteer' ?>" role="button">
