                ...
                <div class="tab-content">
                    <div id="step1" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?= $appform->address ?>" name="address" class="form-control" placeholder="Present Address">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" value="<?= $appform->work?>" name="work" class="form-control" placeholder="Work">
                                    <?= form_error('work', '<span class="label label-danger">', '</span>') ?>
                                </div>
                                <div class="col-sm-4">
                                    <label for="cell">Cell:</label>
                                    <input type="text" value="<?= $appform->cellphone?>" name="cellphone" class="form-control" placeholder="Cellphone number">
                                    <?= form_error('cellphone', '<span class="label label-danger">', '</span>') ?>
                                </div>
                                <div class="col-sm-4">
                                    <label for="phone">Phone:</label>
                                    <input type="text" value="<?= $appform->telephone?>" name="telephone" class="form-control" placeholder="Telephone number">
                    ...
                    <div id="step2" class="tab-pane fade">
                        ...
                        <div class="form-inline">
                            ...
                            <label class="mr"><input <?php if($appform->checkHome != NULL){ echo 'checked'; } ?> type="checkbox" name="checkHome" value="Home">Home</label>
                            <label class="mr"><input <?php if($appform->checkApartment != NULL){ echo 'checked'; } ?> type="checkbox" name="checkApartment" value="Apartment">Apartment</label>
                            <label class="mr"><input <?php if($appform->checkTownhouse != NULL){ echo 'checked'; } ?> type="checkbox" name="checkTownhouse" value="Townhouse">Townhouse</label>
                            <label class="mr"><input <?php if($appform->checkCondo != NULL){ echo 'checked'; } ?> type="checkbox" name="checkCondo" value="Condo">Condo</label>
                            <label class="mr"><input <?php if($appform->checkDorm != NULL){ echo 'checked'; } ?> type="checkbox" name="checkDorm" value="Dorm">Dorm</label>
                        </div>
                        <div class="form-inline">
                            <label class="mr">Do you own? Rent</label>
                            <label class="mr"><input <?php if($appform->rentown == 'Own'){ echo 'checked'; } ?> type="radio" value="Own" name="rentown">Own</label>
                            <label class="mr"><input <?php if($appform->rentown == 'Rent'){ echo 'checked'; } ?> type="radio" value="Rent" name="rentown">Rent</label>
                        </div>
                        <div class="form-inline">
                            <label class="mr">Living with relatives?</label>
                            <label class="mr"><input <?php if($appform->living == 'Yes'){ echo 'checked'; } ?> type="radio" value="Yes" name="living">Yes</label>
                            <label class="mr"><input <?php if($appform->living == 'No'){ echo 'checked'; } ?> type="radio" value="No" name="living">No</label>
                        ...
                        <div class="form-inline">
                            ...
                            <label class="mr"><input <?php if($appform->allergy == 'Yes'){ echo 'checked'; } ?> type="radio" value="Yes" name="allergy">Yes</label>
                            <label class="mr"><input <?php if($appform->allergy == 'No'){ echo 'checked'; } ?> type="radio" value="No" name="allergy" >No</label>
                    ...
                    <div id="step3" class="tab-pane fade">
                        <div class="form-inline">
                            ...
                            <label class="mr"><input <?php if($appform->support == 'Yes'){ echo 'checked'; } ?> type="radio" value="Yes" name="support">Yes</label>
                            <label class="mr"><input <?php if($appform->support == 'No'){ echo 'checked'; } ?> type="radio" value="No" name="support" >No</label>
                        </div>
                        <div class="form-inline">
                            <label class="mr">Are you planning to move in the future?</label>
                            <label class="mr"><input <?php if($appform->move == 'Yes'){ echo 'checked'; } ?> type="radio" value="Yes" name="move">Yes</label>
                            <label class="mr"><input <?php if($appform->move == 'No'){ echo 'checked'; } ?> type="radio" value="No" name="move">No</label>
                            <label class="mr">If yes, when?</label>
                            <input type="text" value="<?=$appform->moveDate?>" name="moveDate" class="form-control">
                        </div>
                        <hr>
                        <div class="form-inline">
                            <label class="mr">2. Who will be responsible for the pets care?</label>
                            <label class="mr"><input <?php if($appform->checkMyself != NULL){ echo 'checked'; } ?> type="checkbox" name="checkMyself" value="Myself">Myself</label>
                            <label class="mr"><input <?php if($appform->checkChildren != NULL){ echo 'checked'; } ?> type="checkbox" name="checkChildren" value="Children">Children</label>
                            <label class="mr"><input <?php if($appform->checkRelatives != NULL){ echo 'checked'; } ?> type="checkbox" name="checkRelatives" value="Relatives">Relatives</label>
                            <label class="mr"><input <?php if($appform->checkOthers != NULL){ echo 'checked'; } ?> type="checkbox" name="checkOthers" value="Others">Others</label>
                        </div>
                        <div class="form-inline">
                            <label class="mr">3. What is your source of income?</label>
                            <label class="mr"><input <?php if($appform->checkEmployed != NULL){ echo 'checked'; } ?> type="checkbox" name="checkEmployed" value="Employed">Employed</label>
                            <label class="mr"><input <?php if($appform->checkSelfEmp != NULL){ echo 'checked'; } ?> type="checkbox" name="checkSelfEmp" value="Self-Employed">Self-Employed</label>
                            <label class="mr"><input <?php if($appform->checkNone != NULL){ echo 'checked'; } ?> type="checkbox" name="checkNone" value="None">None</label>
                        </div>
                        <hr>
                        <div class="form-inline">
                            <label class="mr">4. Have you ever adopted an animal from a shelter?</label>
                            <label class="mr"><input <?php if($appform->adopted == 'Yes'){ echo 'checked'; } ?> type="radio" value="Yes" name="adopted">Yes</label>
                            <label class="mr"><input <?php if($appform->adopted == 'No'){ echo 'checked'; } ?> type="radio" value="No" name="adopted" >No</label>
                        </div>
                        <div class="form-inline">
                            <label class="mr">5. Do you plan to give this pet as a gift?</label>
                            <label class="mr"><input <?php if($appform->gift == 'Yes'){ echo 'checked'; } ?> type="radio" value="Yes" name="gift">Yes</label>
                            <label class="mr"><input <?php if($appform->gift == 'No'){ echo 'checked'; } ?> type="radio" value="No" name="gift">No</label>
                    ...
                    <div id="step4" class="tab-pane fade">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <label><input <?php if($appform->atDay == 'Indoors'){ echo 'checked'; } ?> type="radio" value="Indoors" name="atDay">Indoors</label>
                                </div>
                                <div class="col-sm-2">
                                    <label><input <?php if($appform->atDay == 'In/Out'){ echo 'checked'; } ?> type="radio" value="In/Out" name="atDay">In/Out</label>
                                </div>
                                <div class="col-sm-2">
                                    <label><input <?php if($appform->atDay == 'Patio'){ echo 'checked'; } ?> type="radio" value="Patio" name="atDay">Patio</label>
                                </div>
                                <div class="col-sm-3">
                                    <label><input type="radio" <?php if($appform->atDay == 'Outside with proper shelter'){ echo 'checked'; } ?> value="Outside with proper shelter" name="atDay">Outside with proper shelter</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-2">
                                    <label><input <?php if($appform->atNight == 'Indoors'){ echo 'checked'; } ?> type="radio" value="Indoors" name="atNight">Indoors</label>
                                </div>
                                <div class="col-sm-2">
                                    <label><input <?php if($appform->atNight == 'In/Out'){ echo 'checked'; } ?> type="radio" value="In/Out" name="atNight">In/Out</label>
                                </div>
                                <div class="col-sm-2">
                                    <label><input <?php if($appform->atNight == 'Patio'){ echo 'checked'; } ?> type="radio" value="Patio" name="atNight">Patio</label>
                                </div>
                                <div class="col-sm-3">
                                    <label><input type="radio" <?php if($appform->atNight == 'Outside with proper shelter'){ echo 'checked'; } ?> value="Outside with proper shelter" name="atNight">Outside with proper shelter</label>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="listown" id="" cols="30" rows="5" placeholder="Breed/Age/Gender/Name"><?=$appform->listown?></textarea>
                        </div>
                        <div class="row">
                    ...
                    <div id="step5" class="tab-pane fade">
                        <div class="form-inline">
                            ...
                            <label class="mr"><input <?php if($appform->leftDuration == '0'){ echo 'checked'; } ?> type="radio" value="0" name="leftDuration">0</label>
                            <label class="mr"><input <?php if($appform->leftDuration == '1-3'){ echo 'checked'; } ?> type="radio" value="1-3" name="leftDuration">1-3 Hours</label>
                            <label class="mr"><input <?php if($appform->leftDuration == '3-6'){ echo 'checked'; } ?> type="radio" value="3-6" name="leftDuration">3-6 Hours</label>
                            <label class="mr"><input <?php if($appform->leftDuration == '6+'){ echo 'checked'; } ?> type="radio" value="6+" name="leftDuration">6+ Hours</label>
                        </div>
                        <div class="form-inline">
                            <label class="mr">8. What type of diet/food you plan to feed the dog?</label>
                            <label class="mr"><input <?php if($appform->food == 'Dry Food'){ echo 'checked'; } ?> type="radio" value="Dry Food" name="food">Dry Food</label>
                            <label class="mr"><input <?php if($appform->food == 'Canned Food'){ echo 'checked'; } ?> type="radio" value="Canned Food" name="food">Canned Food</label>
                            <label class="mr"><input <?php if($appform->food == 'Home Cooked'){ echo 'checked'; } ?> type="radio" value="Home Cooked" name="food">Home Cooked</label>
                            <label class="mr"><input <?php if($appform->food == 'Others'){ echo 'checked'; } ?> type="radio" value="Others" name="food">Others</label>
                        </div>
                        <hr>
                        <div class="form-inline">
                            <label class="mr">9. Do you have a veterinarian?</label>
                            <label class="mr"><input type="radio" <?php if($appform->vet == 'Yes'){ echo 'checked'; } ?> value="Yes" name="vet">Yes</label>
                            <label class="mr"><input type="radio" <?php if($appform->vet == 'No'){ echo 'checked'; } ?> value="No" name="vet" >No</label>
                        </div>
                        <div class="form-inline">
                            <label class="mr">10. How tall is the fence you currently have?</label>
                            <label class="mr"><input type="radio" <?php if($appform->fenceHeight == 'Tall'){ echo 'checked'; } ?> value="Tall" name="fenceHeight">Tall</label>
                            <label class="mr"><input type="radio" <?php if($appform->fenceHeight == 'Average'){ echo 'checked'; } ?> value="Average" name="fenceHeight">Average</label>
                            <label class="mr"><input type="radio" <?php if($appform->fenceHeight == 'Short'){ echo 'checked'; } ?> value="Short" name="fenceHeight" >Short</label>
                        </div>
                        <hr>
                        <div class="row">
                    ...
                    <div id="step6" class="tab-pane fade">
                        <div class="form-group">
                            ...
                            <textarea name="pastExp" id="" cols="15" rows="4" class="form-control"><?= $appform->pastExp ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="">PLEASE GIVE US A BRIEF EXPLANATION OF YOUR REASONS FOR WANTING TO ADOPT THIS PET </label>
                            <textarea name="reason" id="" cols="15" rows="4" class="form-control"><?= $appform->reason ?></textarea>
                        </div>
                        <div class="form-inline">
                        ...
                        <hr>
                        <a class="btn btn-primary pull-right" data-toggle="modal" href="#myModal">Update Information</a>
